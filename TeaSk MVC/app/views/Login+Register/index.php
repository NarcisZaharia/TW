...
<head>
    ...
    <link rel="stylesheet" href="http://localhost/TeaSk%20MVC/public/css/Login+Register.css">
    <meta charset="UTF-8">
</head>
<body>
...
<main>
    ...
    <div class="right styleright scrollbar" id = "contentright">
        <p><b>LOGIN</b></p>
        <form action="http://localhost/TeaSk%20MVC/public/login/checkLogin" method = "POST">
        ...
        <p><b>REGISTER</b></p>
        <form action="http://localhost/TeaSk%20MVC/public/register/checkRegister" method = "POST">
            <div class = "styleregister">
